...
SAMPLE = os.path.join(DATA_DIR, "tfda_health_sample.csv")
...
def fetch() -> list[dict]:
    try:
        ...
        content, filename = resp.content, "tfda_health.csv"
    except Exception as e:
        logging.warning("TFDA health fetch failed: %s, fallback sample", e)
